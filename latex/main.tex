...
\emph{directly identified closed-loop model} ridge-fitted on every tracked
stabilized sample of the session rather than composing the bare airframe
with the inverse-dynamics controller estimate: the closed loop is abundantly
excited by the lap data and is exactly what stabilized segments replay,
