...
middle position), so the pilot-perceived low-airspeed
unresponsiveness is not a control-law gate but an authority contest ---
the self-leveling loop holds wings level with full servo authority while
the clipped bank command acts through collapsing dynamic pressure. A
